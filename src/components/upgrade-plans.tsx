...
const PLANS: {
...
}[] = [
  {
    ...
    outcomes: [
      ...
      "Journalling, with a reflection on what you wrote",
      "Daily check-ins, and the patterns they show",
    ],
    limits: [
      "5 support messages a day",
      "3 journal reflections a day",
      "3 check-ins a day",
      "2 pattern reads a day",
    ],
  },
  {
    id: "pro",
    ...
    outcomes: [
      ...
      "Ten tools, including sleep and work pressure",
      "Unlimited check-ins",
      "Support chat that remembers the thread of it",
    ],
    limits: [
      "200 support messages a month",
      "100 journal reflections a month",
      "60 pattern reads a month",
      "Unlimited check-ins",
    ],
  },
  {
    ...
    outcomes: [
      ...
      "Memory that carries across months of entries",
      "The longest view of your patterns",
      "Room to use it daily without counting",
    ],
    limits: [
      "800 support messages a month",
      "300 journal reflections a month",
      "200 pattern reads a month",
      "Unlimited check-ins",
    ],
  },
];
